    <div class="page">
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Admin Seller</li>
            </ol>
        </div>
        <div class="page-content">
            <div class="panel">
                <header class="panel-heading">
                    ...
                    <h3 class="panel-title">Seller Admin WTB</h3>
                </header>
                <div class="panel-body">
                    <a href="{{ route('add-member', ['type' => 'seller-adm']) }}" class="btn btn-icon btn-primary btn-xs">Tambah Seller Admin</a> 
    ...
    <script>
        ...
        function editIt(id) {
	        ...
	        link = link.replace(':param', 'seller-adm');
