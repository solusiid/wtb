        ...
        <div class="page-content">
            <div class="panel">
                <header class="panel-heading">
                    ...
                    <h3 class="panel-title">Upload Sub Category</h3>
                </header>
            ...
            <div class="panel">
                <header class="panel-heading">
                    <div class="panel-actions"></div>
                    <h3 class="panel-title">Category Item WTB</h3>
                </header>
                <div class="panel-body">
                    <a href="{{ route('tambah-data', ['id'=>'category']) }}" class="btn btn-icon btn-primary btn-xs">Tambah Sub Category</a>
    ...
    <script>
        ...
        function viewIt(id) {
	        ...
	        link = link.replace(':param', 'category');
