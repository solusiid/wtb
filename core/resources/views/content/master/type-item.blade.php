        ...
        <div class="page-content">
            <div class="panel">
                <header class="panel-heading">
                    ...
                    <h3 class="panel-title">Upload Type Item</h3>
                </header>
            ...
            <div class="panel">
                <header class="panel-heading">
                    <div class="panel-actions"></div>
                    <h3 class="panel-title">Type Item WTB</h3>
                </header>
                <div class="panel-body">
                    <a href="{{ route('tambah-data', ['id'=>'type']) }}" class="btn btn-icon btn-primary btn-xs">Tambah Tipe Item</a>
