    <div class="page">
        ...
        <div class="page-content">
            ...
            <!--        <h3 class="panel-title">Upload Main Category</h3>-->
            <!--    </header>-->
            ...
            <div class="panel">
                <header class="panel-heading">
                    <div class="panel-actions"></div>
                    <h3 class="panel-title">Main Category WTB</h3>
                </header>
                <div class="panel-body">
                    <a href="{{ route('tambah-data', ['id'=>'mcategory']) }}" class="btn btn-icon btn-primary btn-xs">Tambah Category</a>
    ...
    <script>
        ...
        function viewIt(id) {
	        ...
	        link = link.replace(':param', 'mcategory');
